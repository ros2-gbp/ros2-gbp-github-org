...
locals {
  organization_repositories = setunion(
    ...
    local.humanoid_robot_intelligence_control_system_module_repositories,
    local.humanoid_robot_intelligence_control_system_demos_repositories,
    local.humanoid_robot_intelligence_control_system_messages_repositories,
    local.humanoid_robot_intelligence_control_system_utility_repositories,
    local.humanoid_robot_intelligence_control_system_framework_repositories,
    local.humanoid_robot_intelligence_control_system_tools_repositories,
