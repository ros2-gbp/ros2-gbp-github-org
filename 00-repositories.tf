...
locals {
  organization_repositories = setunion(
    ...
    local.accelerated_memory_transports_repositories,
    ...
    local.grasp_synergy_adapter_repositories,
    ...
    local.robstride_ros2_repositories,
    ...
    local.signetlabdei_repositories,
