...
locals {
  members = setunion(
    ...
    local.humanoid_robot_intelligence_control_system_demos_team,
    local.humanoid_robot_intelligence_control_system_messages_team,
    local.humanoid_robot_intelligence_control_system_utility_team,
    local.humanoid_robot_intelligence_control_system_framework_team,
    local.humanoid_robot_intelligence_control_system_tools_team,
    local.naoqi_team,
